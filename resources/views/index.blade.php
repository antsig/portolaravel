    ...
    <main class="relative pt-16 overflow-hidden min-h-screen">
                    ...
                    <div class="flex-1 w-full max-w-md relative flex justify-center group">
                        ...
                        <div class="relative w-72 h-72 sm:w-80 sm:h-80 rounded-full p-2.5 ring-4 ring-primary/80 ring-offset-4 ring-offset-slate-50 dark:ring-offset-slate-950 shadow-2xl overflow-hidden bg-slate-950 flex items-center justify-center">
                            ...
                            @if(isset($settings['hero_image']))
                                <img src="{{ asset('storage/'.$settings['hero_image']) }}" alt="Brand Image" class="w-full h-full object-cover rounded-full filter brightness-95 group-hover:scale-105 transition-transform duration-700">
                            @else
        ...
        <section id="about" class="pt-8 sm:pt-10 pb-16 sm:pb-20 bg-white dark:bg-slate-950/40 border-y border-slate-200/30 dark:border-slate-900/50">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="mt-16">
                    <h4 class="text-xl font-bold mb-6 text-slate-800 dark:text-slate-200 border-l-4 border-primary pl-4">Focus Areas</h4>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="p-6 rounded-2xl bg-slate-50 dark:bg-slate-900/40 border border-slate-200/50 dark:border-slate-850 hover:border-primary/50 dark:hover:border-primary/50 hover:shadow-md transition-all duration-300 group">
                            <div class="flex items-start gap-4">
                                ...
                                <div class="space-y-1">
                                    <h5 class="font-bold text-base text-slate-800 dark:text-slate-200">Software Engineering</h5>
                                    <p class="text-xs text-slate-500 dark:text-slate-400 leading-relaxed text-justify">
                                        Merancang arsitektur perangkat lunak yang berkinerja tinggi, berskala global, dan tangguh menggunakan teknologi kelas dunia.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-6 rounded-2xl bg-slate-50 dark:bg-slate-900/40 border border-slate-200/50 dark:border-slate-850 hover:border-primary/50 dark:hover:border-primary/50 hover:shadow-md transition-all duration-300 group">
                            <div class="flex items-start gap-4">
                                ...
                                <div class="space-y-1">
                                    <h5 class="font-bold text-base text-slate-800 dark:text-slate-200">Innovation & Discovery</h5>
                                    <p class="text-xs text-slate-500 dark:text-slate-400 leading-relaxed text-justify">
                                        Mengeksplorasi konsep, mendesain prototipe interaktif (MVP), dan memvalidasi model bisnis digital dengan eksekusi tangkas.
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 mt-16">
                    <div class="flex flex-col items-center justify-center p-6 rounded-2xl bg-slate-50 dark:bg-slate-900/20 border border-slate-200/50 dark:border-slate-900/60 hover:bg-slate-100 dark:hover:bg-slate-900/40 transition-colors">
                        <span class="text-4xl font-extrabold text-primary mb-1">50+</span>
                        <span class="text-[10px] sm:text-xs uppercase tracking-widest text-slate-500 dark:text-slate-400 font-bold text-center">Proyek Selesai</span>
                    </div>
                    <div class="flex flex-col items-center justify-center p-6 rounded-2xl bg-slate-50 dark:bg-slate-900/20 border border-slate-200/50 dark:border-slate-900/60 hover:bg-slate-100 dark:hover:bg-slate-900/40 transition-colors">
                        <span class="text-4xl font-extrabold text-primary mb-1">12+</span>
                        <span class="text-[10px] sm:text-xs uppercase tracking-widest text-slate-500 dark:text-slate-400 font-bold text-center">Startup Venture</span>
                    </div>
                    <div class="flex flex-col items-center justify-center p-6 rounded-2xl bg-slate-50 dark:bg-slate-900/20 border border-slate-200/50 dark:border-slate-900/60 hover:bg-slate-100 dark:hover:bg-slate-900/40 transition-colors">
                        <span class="text-4xl font-extrabold text-primary mb-1">99.9%</span>
                        <span class="text-[10px] sm:text-xs uppercase tracking-widest text-slate-500 dark:text-slate-400 font-bold text-center">Uptime Sistem</span>
                    </div>
                    <div class="flex flex-col items-center justify-center p-6 rounded-2xl bg-slate-50 dark:bg-slate-900/20 border border-slate-200/50 dark:border-slate-900/60 hover:bg-slate-100 dark:hover:bg-slate-900/40 transition-colors">
                        <span class="text-4xl font-extrabold text-primary mb-1">10M+</span>
                        <span class="text-[10px] sm:text-xs uppercase tracking-widest text-slate-500 dark:text-slate-400 font-bold text-center">Pengguna Aktif</span>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section id="projects" class="pt-10 sm:pt-14 pb-16 sm:pb-20 bg-white dark:bg-slate-950/40 border-y border-slate-200/30 dark:border-slate-900/50">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div class="group rounded-3xl bg-white dark:bg-slate-950 overflow-hidden shadow-lg border border-slate-200/60 dark:border-slate-900 transition-all hover:-translate-y-2 hover:shadow-xl hover:border-primary/30 duration-300">
                        <!-- Image Container with zoom -->
                        <div class="h-48 overflow-hidden relative bg-slate-100 dark:bg-slate-900 border-b border-slate-200/50 dark:border-slate-900">
                        ...
                        <div class="p-6 flex flex-col h-56 justify-between">
                            <div class="space-y-2">
                                <h4 class="text-lg font-bold text-slate-800 dark:text-slate-200 group-hover:text-primary transition-colors duration-200">{{ $project->title }}</h4>
                                <p class="text-slate-500 dark:text-slate-400 text-xs leading-relaxed line-clamp-3 text-justify">
                                    {{ $project->description }}
                                </p>
                            </div>
                            ...
                            <div class="pt-4 border-t border-slate-100 dark:border-slate-900">
                                <a href="{{ $project->link }}" target="_blank" class="inline-flex items-center gap-1.5 text-xs font-bold text-primary hover:text-primary/80 transition-colors">
        ...
        <section id="contact" class="pt-10 sm:pt-14 pb-16 sm:pb-20 bg-white dark:bg-slate-950/40 border-t border-slate-200/30 dark:border-slate-900/50">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto w-full items-center">
                    ...
                    <div class="w-full">
                        <div class="bg-white dark:bg-slate-950 border border-slate-200/60 dark:border-slate-900 rounded-3xl shadow-xl p-6 sm:p-8">
                            <h4 class="text-lg font-bold mb-6 text-slate-800 dark:text-slate-200 border-l-4 border-primary pl-4">Connect on Social</h4>
